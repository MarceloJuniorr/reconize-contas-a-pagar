...
import { LayoutDashboard, FileText, Building2, MapPin, LogOut, Users, Menu, Store, Package, Warehouse, UserCheck, ShoppingCart, CreditCard, ShoppingBag, Receipt, Calculator } from 'lucide-react';
...
const Layout = () => {
  ...
  if (hasStoreAccess) {
    ...
    navigation.push({ name: 'Contas a Receber', href: '/accounts-receivable', icon: Receipt });
    navigation.push({ name: 'Fechamento Caixa', href: '/cash-closing', icon: Calculator });
