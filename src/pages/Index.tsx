...
import { FileText, Clock, CheckCircle, AlertCircle, Plus, Building2, MapPin, Users } from 'lucide-react';
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {loading ? '...' : stats.totalOpen}
            </div>
            <p className="text-xs text-muted-foreground">
              {loading ? '...' : formatCurrency(stats.totalOpenAmount)}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {loading ? '...' : formatCurrency(stats.totalOverdueAmount)}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {loading ? '...' : formatCurrency(stats.totalPaidAmount)}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">
              {loading ? '...' : stats.totalNext7Days}
            </div>
            <p className="text-xs text-muted-foreground">
              {loading ? '...' : formatCurrency(stats.totalNext7DaysAmount)}
            </p>
          </CardContent>
        </Card>
      </div>
